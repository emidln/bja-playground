...
{{
var G__6718 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6718;
continue;
}
} else
...
{var pred__6722 = cljs.core._EQ_;var expr__6723 = limit;if(pred__6722.call(null,1,expr__6723))
{return cljs.core.vector.call(null,s);
} else
{if(pred__6722.call(null,2,expr__6723))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__6725 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6726 = (limit__$1 - 1);
var G__6727 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6725;
limit__$1 = G__6726;
parts = G__6727;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6729 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6729))
{var replacement_6730 = temp__4090__auto___6729;buffer.append([cljs.core.str(replacement_6730)].join(''));
} else
{buffer.append(ch);
}
{
