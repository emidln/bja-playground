...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__2972__auto__ = reader;if(and__2972__auto__)
...
{var x__3576__auto__ = (((reader == null))?null:reader);return (function (){var or__2981__auto__ = (cljs.reader.read_char[goog.typeOf(x__3576__auto__)]);if(or__2981__auto__)
{return or__2981__auto__;
} else
{var or__2981__auto____$1 = (cljs.reader.read_char["_"]);if(or__2981__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__2972__auto__ = reader;if(and__2972__auto__)
...
{var x__3576__auto__ = (((reader == null))?null:reader);return (function (){var or__2981__auto__ = (cljs.reader.unread[goog.typeOf(x__3576__auto__)]);if(or__2981__auto__)
{return or__2981__auto__;
} else
{var or__2981__auto____$1 = (cljs.reader.unread["_"]);if(or__2981__auto____$1)
{return or__2981__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__3517__auto__,writer__3518__auto__,opt__3519__auto__){return cljs.core._write.call(null,writer__3518__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__2981__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__7156){
var rdr = cljs.core.first(arglist__7156);
var msg = cljs.core.rest(arglist__7156);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__2972__auto__ = !((ch === "#"));if(and__2972__auto__)
{var and__2972__auto____$1 = !((ch === "'"));if(and__2972__auto____$1)
{var and__2972__auto____$2 = !((ch === ":"));if(and__2972__auto____$2)
...
{{
var G__7157 = (function (){sb.append(ch);
return sb;
})();
var G__7158 = cljs.reader.read_char.call(null,rdr);
sb = G__7157;
ch = G__7158;
continue;
}
...
var ch = cljs.reader.read_char.call(null,reader);if(((ch === "n")) || ((ch === "r")) || ((ch == null)))
{return reader;
} else
{{
continue;
...
{{
var G__7159 = cljs.reader.read_char.call(null,rdr);
ch = G__7159;
continue;
}
} else
...
var G__7160 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__7160;
continue;
}
} else
...
var G__7161 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__7161;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__2981__auto__ = (ch == null);if(or__2981__auto__)
{return or__2981__auto__;
} else
{var or__2981__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__2981__auto____$1)
{return or__2981__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__2981__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
...
{{
var G__7162 = (function (){buffer.append(ch);
return buffer;
})();
var G__7163 = cljs.reader.read_char.call(null,reader);
buffer = G__7162;
ch = G__7163;
continue;
}
...
{if(("\\" === ch))
{{
var G__7164 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__7165 = cljs.reader.read_char.call(null,reader);
buffer = G__7164;
ch = G__7165;
continue;
}
...
{{
var G__7166 = (function (){buffer.append(ch);
return buffer;
})();
var G__7167 = cljs.reader.read_char.call(null,reader);
buffer = G__7166;
ch = G__7167;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__7169 = o;if(G__7169)
{var bit__3592__auto__ = (G__7169.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__3592__auto__) || (G__7169.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__7169.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__7169);
} else
{return false;
}
}
...
{{
var G__7170 = reader;
var G__7171 = eof_is_error;
var G__7172 = sentinel;
var G__7173 = is_recursive;
reader = G__7170;
eof_is_error = G__7171;
sentinel = G__7172;
is_recursive = G__7173;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__7174 = cljs.reader.read_comment.call(null,reader,ch);
var G__7175 = eof_is_error;
var G__7176 = sentinel;
var G__7177 = is_recursive;
reader = G__7174;
eof_is_error = G__7175;
sentinel = G__7176;
is_recursive = G__7177;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__2972__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__2972__auto__))
{var or__2981__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__7184 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__7184,0,null);var years = cljs.core.nth.call(null,vec__7184,1,null);var months = cljs.core.nth.call(null,vec__7184,2,null);var days = cljs.core.nth.call(null,vec__7184,3,null);var hours = cljs.core.nth.call(null,vec__7184,4,null);var minutes = cljs.core.nth.call(null,vec__7184,5,null);var seconds = cljs.core.nth.call(null,vec__7184,6,null);var fraction = cljs.core.nth.call(null,vec__7184,7,null);var offset_sign = cljs.core.nth.call(null,vec__7184,8,null);var offset_hours = cljs.core.nth.call(null,vec__7184,9,null);var offset_minutes = cljs.core.nth.call(null,vec__7184,10,null);var v = vec__7184;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__2981__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__2981__auto__))
{return or__2981__auto__;
} else
{return 0;
}
...
{var vec__7186 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__7186,0,null);var months = cljs.core.nth.call(null,vec__7186,1,null);var days = cljs.core.nth.call(null,vec__7186,2,null);var hours = cljs.core.nth.call(null,vec__7186,3,null);var minutes = cljs.core.nth.call(null,vec__7186,4,null);var seconds = cljs.core.nth.call(null,vec__7186,5,null);var ms = cljs.core.nth.call(null,vec__7186,6,null);var offset = cljs.core.nth.call(null,vec__7186,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
